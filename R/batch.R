...
build_batch_prompt_rewrite <- function(contexts, keys, min_chars, max_chars) {
  ...
  sprintf(
    paste0(
      ...
      "Baseline: \"Processen viser stabil og forudsigelig adf\u00e6rd. Variationen er naturlig, og der er ingen tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger under m\u00e5let (60%%). Forbedring kr\u00e6ver en bevidst \u00e6ndring af processen \u2013 den nuv\u00e6rende praksis vil levere samme resultat.\"\n",
      "Definition: \"Andelen af patienter der modtager antibiotika inden 3 timer\"\n",
      "God omskrivning (340 tegn): \"Andelen af patienter der modtager antibiotika inden 3 timer viser en stabil og forudsigelig adf\u00e6rd med naturlig variation. Niveauet ligger dog under m\u00e5let p\u00e5 60%%. **En bevidst proces\u00e6ndring er n\u00f8dvendig** for at l\u00f8fte niveauet, da den nuv\u00e6rende praksis vil forts\u00e6tte med at levere de samme resultater.\"\n\n",
      "Eksempel 2 (stabil, m\u00e5l opfyldt):\n",
      "Baseline: \"Processen viser stabil og forudsigelig adf\u00e6rd. Variationen er naturlig, og der er ingen tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger t\u00e6t p\u00e5 m\u00e5let (97%%). Forts\u00e6t den nuv\u00e6rende praksis og overv\u00e5g processen l\u00f8bende for at fastholde det gode niveau.\"\n",
