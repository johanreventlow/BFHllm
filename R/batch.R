...
build_batch_prompt_rewrite <- function(contexts, keys, min_chars, max_chars) {
  ...
  sprintf(
    paste0(
      ...
      "Baseline: \"Processen er stabil og forudsigelig. Variationen er naturlig uden tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger under m\u00e5let (60%%). En bevidst proces\u00e6ndring er n\u00f8dvendig. Den nuv\u00e6rende praksis vil forts\u00e6tte med at levere de samme resultater.\"\n",
      "Definition: \"Andelen af patienter der modtager antibiotika inden 3 timer\"\n",
      "God omskrivning (340 tegn): \"Andelen af patienter der modtager antibiotika inden 3 timer viser en stabil og forudsigelig proces uden tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger under m\u00e5let p\u00e5 60%%. **En bevidst proces\u00e6ndring er n\u00f8dvendig.** Den nuv\u00e6rende praksis vil forts\u00e6tte med at levere de samme resultater.\"\n\n",
      "Eksempel 2 (stabil, m\u00e5l opfyldt):\n",
      "Baseline: \"Processen er stabil og forudsigelig. Variationen er naturlig uden tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger t\u00e6t p\u00e5 m\u00e5let (97%%). Forts\u00e6t den nuv\u00e6rende praksis og overv\u00e5g processen l\u00f8bende for at fastholde det gode niveau.\"\n",
      "Definition: \"Registreret komplet klinisk TNM\"\n",
      "God omskrivning (330 tegn): \"Registrering af komplet klinisk TNM viser en stabil og forudsigelig proces uden tegn p\u00e5 systematiske \u00e6ndringer. Niveauet ligger t\u00e6t p\u00e5 m\u00e5let p\u00e5 97%%. **Forts\u00e6t den nuv\u00e6rende praksis** og overv\u00e5g processen l\u00f8bende for at fastholde det gode niveau.\"\n\n",
      "Eksempel 3 (ustabil):\n",
      "Baseline: \"Processen viser systematisk ustabilitet. B\u00e5de seriel\u00e6ngde (9 > 8) og antal krydsninger (12 < 13) afviger fra det forventede. Dette peger p\u00e5 en grundl\u00e6ggende proces\u00e6ndring. Niveauet ligger under m\u00e5let (80%%). Identificer og fjern de s\u00e6rlige \u00e5rsager til variationen f\u00f8r yderligere forbedringstiltag iv\u00e6rks\u00e6ttes.\"\n",
